...
function SendMoney(){
    ...
    const handleSubmit = async (e) => {
        ...
        if (!sender || !receiver || !amount) {
          ...
          try {
            ...
            const q = query(customersRef, where('FullName', '==', receiver));
    ...
    return(
        ...
        <div  className="flex items-center justify-center bg-gray-900 h-96">
            ...
            <div className="bg-gray-700 h-auto w-80 items-center justify-center shadow-2xl shadow-gray-950 p-4 mb-3">
                <div ><p className="text-white text-center text-2xl font-semibold">Transfer Money</p></div>
                <Form onSubmit={handleSubmit}>
                    ...
                    {' '}
                    <input type='submit' className="bg-blue-500 hover:bg-blue-700  text-white font-bold mt-4 py-2 px-4 rounded"  value='transfer'/>
